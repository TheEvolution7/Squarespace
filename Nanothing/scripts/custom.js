...
$(document).ready(function() {
    ...
    function scrollFunction() {
        ...
        if (
          document.documentElement.scrollTop > 1 && window.oldScroll > window.scrollY
        ) {
    ...
    if (jQuery(".roadmap-slider").length > 0) {
        console.log('aaaa')
    ...
    // if (jQuery(".nano-slider").length > 0) {
    //     console.log('aaaa')
    //     $('.nano-slider').owlCarousel({
    //         loop: false,
    //         margin: 0,
    //         nav: true,
    //         dots: false,
    ...
    var sync1 = $(".nano-slider");
    var sync2 = $(".thumb-nail-nano");
