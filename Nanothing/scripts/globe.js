...
var props = {
  ...
  globeRadius: 500, // Radius of the globe (used for many calculations)
  dotsAmount: 20, // Amount of dots to generate and animate randomly across the lines
  startingCountry: 'unitedstate', // The key of the country to rotate the camera to during the introduction animation (and which country to start the cycle at)
  colours: {
    // Cache the colours
    globeDots: 'rgb(42,172,227)', // No need to use the Three constructor as this value is used for the HTML canvas drawing 'fillStyle' property
    lines: new THREE.Color('#2aace3'),
    lineDots: new THREE.Color('#2aace3')
  },
  alphas: {
...
function getData() {
  ...
  request.open('GET', 'assets/json/globe-points.json', true);
...
function addGlobe() {
  ...
  canvasGradient.addColorStop(1, 'rgba(42,172,227,0.05)');
  canvasGradient.addColorStop(1, 'rgba(42,172,227,0.05)');
  canvasGradient.addColorStop(1, 'rgba(42,172,227,0.05)');
